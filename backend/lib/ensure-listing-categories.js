  ...
  const defaults = [
    ...
    },
    {
      ...
      listingTypes: [
        ...
        { slug: 'dyqan', label: 'Dyqan' },
        { slug: 'supermarket', label: 'Supermarket & market' },
        { slug: 'farmacie', label: 'Farmaci' },
        { slug: 'salone-bukurie', label: 'Sallon bukurie' },
        { slug: 'palester', label: 'Palestër & fitness' },
        { slug: 'hotel', label: 'Hotel & akomodim' },
        { slug: 'sherbime-auto', label: 'Shërbime auto' },
        { slug: 'sherbime-shtepie', label: 'Shërbime shtëpie' },
        { slug: 'te-tjera', label: 'Të tjera' },
      ],
    },
    {
      key: 'professionals',
