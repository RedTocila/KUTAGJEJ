...
const professionalListingReviewSchema = new mongoose.Schema(
  {
...
professionalListingReviewSchema.index(
  { listingId: 1, reviewerId: 1, reviewerModel: 1 },
  { unique: true },
);

module.exports = mongoose.model('ProfessionalListingReview', professionalListingReviewSchema);
