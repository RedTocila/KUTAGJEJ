...
const { ensureAddonPackages } = require('./lib/addon-packages');
...
const { ensureAiUsagePricesSchema } = require('./lib/ai-usage-prices');
...
app.use('/api/listings', require('./routes/listing-maps'));
