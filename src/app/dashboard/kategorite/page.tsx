...
export default function KategoritePage() {
  ...
  }, [user?.id, isPlatformAdmin]); // eslint-disable-line react-hooks/exhaustive-deps -- omit `router` (stable) & `user` (use `id` only — full `user` refetch was resetting the editor mid-save)
