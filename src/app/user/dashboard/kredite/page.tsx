      ...
      >
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Përdorni kreditet për të promovuar njoftimet tuaja.
          </Typography>
        </Box>
        <Stack
          direction="row"
            ...
            <Grid key={pkg.id} size={{ xs: 12, sm: 6, md: 3 }}>
              <Box
                sx={{
                  ...
                  '&:hover': { transform: 'translateY(-3px)', boxShadow: '0 12px 26px rgba(0,0,0,0.12)' },
                }}
              >
                {pkg.badgeSq ? (
                  <Chip
                ...
                <CoinsIcon size={34} weight="duotone" color="var(--mui-palette-warning-main)" />
                <Typography sx={{ fontWeight: 800, fontSize: '1.5rem' }}>
                  {new Intl.NumberFormat('en-US').format(pkg.credits)}
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  kredite
                </Typography>
                <Typography sx={{ fontWeight: 800, mt: 'auto' }}>{pkg.priceEur} €</Typography>
                <Button variant="contained" onClick={() => setSelected(pkg)} sx={{ fontWeight: 700 }}>
                  Blej
                </Button>
              </Box>
            </Grid>
            ...
            <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between', gap: 2 }}>
              <Box sx={{ minWidth: 0 }}>
                ...
                <Typography sx={{ fontWeight: 700, lineHeight: 1.25 }}>
                  {new Intl.NumberFormat('en-US').format(selected.credits)} kredite
                </Typography>
                <Typography variant="body2" color="text.secondary">
                  Për promovimin e njoftimeve
                </Typography>
              </Box>
