...
export const CATEGORY_HELP: Record<ListingCategoryKey, string> = {
  ...
  businesses:
    'Llojet e vendeve (p.sh. Restorant, Bar, Kafene, Dyqan, Sallon). Slug-i përdoret në URL — nuk janë shpallje pasurie.',
  professionals:
...
export const CATEGORY_VISUAL: Record<
  ListingCategoryKey,
  { Icon: PhosphorIcon; accent: 'primary' | 'info' | 'warning' | 'success' }
> = {
