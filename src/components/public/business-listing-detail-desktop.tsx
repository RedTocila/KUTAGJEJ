...
import { Box, Button, ButtonBase, Container, Divider, Stack, Typography } from '@mui/material';
import { alpha } from '@mui/material/styles';
import { MapPin as MapPinIcon } from '@phosphor-icons/react/dist/ssr/MapPin';
import { Phone as PhoneIcon } from '@phosphor-icons/react/dist/ssr/Phone';

import { paths } from '@/paths';
import { businessCategorySubtitle, businessOpenStatusLine } from '@/lib/business-listing-detail-content';
            ...
            <Stack direction="row" sx={{ alignItems: 'stretch', minHeight: 0, width: '100%' }}>
              ...
              >
                <Stack spacing={2} sx={{ width: '100%' }}>
                  ...
                  {showReservation ? <BusinessReservationPanel {...reservationPanelProps} /> : null}
          ...
          <Stack spacing={4} sx={{ width: '100%' }}>
            ...
            {mapLocation ? (
              <Box data-business-location-map sx={{ scrollMarginTop: 96 }}>
                ...
                <LocationMapEmbed query={mapLocation.query} lat={mapLocation.lat} lng={mapLocation.lng} height={280} />
              </Box>
            ) : null}
