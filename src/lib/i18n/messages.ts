...
const sq = {
  ...
  aiImport: {
    ...
    formPlaceholder:
      'P.sh. Krijo profil profesionisti për instalime elektrike në Tiranë…\nose ngjit një link Instagram / faqe',
    ...
    editPlaceholder:
      'P.sh. Ndrysho përshkrimin, shto këtë foto si cover, ul çmimin në 50€…',
...
const en: AppMessages = {
  ...
  aiImport: {
    ...
    formPlaceholder:
      'E.g. Create a professional profile for electrical installations in Tirana…\nor paste an Instagram / website link',
    ...
    editPlaceholder:
      'E.g. Rewrite the description, set this photo as cover, lower the price to €50…',
