...
const sq = {
  common: {
    ...
    relativeJustNow: 'Tani',
    relativeMinutesAgo: (n: number) => (n === 1 ? '1 min më parë' : `${n} min më parë`),
    relativeHoursAgo: (n: number) => (n === 1 ? '1 orë më parë' : `${n} orë më parë`),
    relativeDaysAgo: (n: number) => (n === 1 ? '1 ditë më parë' : `${n} ditë më parë`),
    relativeWeeksAgo: (n: number) => (n === 1 ? '1 javë më parë' : `${n} javë më parë`),
    postedToday: 'Postuar sot',
  },
  ...
  browse: {
    ...
    searchSuggestions: 'Sugjerime',
    suggestionFilters: 'Filtra',
    suggestionKeyword: 'Kërkim',
  ...
  messages: {
    ...
    messageActionsAria: 'Veprime për mesazhin',
    deleteMessage: 'Fshi mesazhin',
    deleteMessages: (n: number) => (n === 1 ? 'Fshi mesazhin' : `Fshi ${n} mesazhe`),
    deleteMessageConfirmTitle: 'Fshi mesazhin?',
    deleteMessageConfirmBody: 'Ky mesazh do të fshihet për të gjithë.',
    deleteMessagesConfirmTitle: (n: number) => (n === 1 ? 'Fshi mesazhin?' : `Fshi ${n} mesazhe?`),
    deleteMessagesConfirmBody: 'Mesazhet e zgjedhura do të fshihen për të gjithë.',
    selectedMessagesCount: (n: number) => (n === 1 ? '1 mesazh i zgjedhur' : `${n} mesazhe të zgjedhura`),
    selectMessages: 'Zgjidh',
    cancelSelectionAria: 'Anulo zgjedhjen',
    pinnedAria: 'E fiksuar',
    uploadFailed: 'Nuk u ngarkua fotoja.',
    sendFailed: 'Mesazhi nuk u dërgua.',
    deleteFailed: 'Mesazhi nuk u fshi.',
  },
  packages: {
    ...
    autoRefreshPackageTitle: (n: number) => `${n} Auto-refresh`,
    ...
    bcPurchaseConfirmTitle: 'Konfirmo blerjen',
    bcPurchaseConfirmBody: (label: string, price: string) => `Dëshironi të blini "${label}" për ${price} BC?`,
    bcPurchaseConfirmAction: 'Po, bleje',
  ...
  picker: {
    title: 'Shto një njoftim',
    categoryTitle: (cat: string) => `Shto njoftim · ${cat}`,
  ...
  aiUsage: {
    ...
    aiMenuDetail: 'Për çdo foto të analizuar',
    aiSearch: 'AI Search',
...
const en: AppMessages = {
  common: {
    ...
    relativeMinutesAgo: (n: number) => (n === 1 ? '1 min ago' : `${n} min ago`),
    relativeHoursAgo: (n: number) => (n === 1 ? '1 hour ago' : `${n} hours ago`),
    relativeDaysAgo: (n: number) => (n === 1 ? '1 day ago' : `${n} days ago`),
    relativeWeeksAgo: (n: number) => (n === 1 ? '1 week ago' : `${n} weeks ago`),
  ...
  messages: {
    ...
    deleteMessages: (n: number) => (n === 1 ? 'Delete message' : `Delete ${n} messages`),
    deleteMessageConfirmTitle: 'Delete message?',
    deleteMessageConfirmBody: 'This message will be deleted for everyone.',
    deleteMessagesConfirmTitle: (n: number) => (n === 1 ? 'Delete message?' : `Delete ${n} messages?`),
    deleteMessagesConfirmBody: 'Selected messages will be deleted for everyone.',
    selectedMessagesCount: (n: number) => (n === 1 ? '1 message selected' : `${n} messages selected`),
  ...
  packages: {
    ...
    bcPurchaseConfirmTitle: 'Confirm purchase',
    bcPurchaseConfirmBody: (label: string, price: string) => `Do you want to buy "${label}" for ${price} BC?`,
    bcPurchaseConfirmAction: 'Yes, buy it',
  ...
  picker: {
    title: 'Add a Listing',
    categoryTitle: (cat: string) => `Add Listing · ${cat}`,
  ...
  aiUsage: {
    ...
    aiMenuDetail: 'For each analyzed image',
    aiSearch: 'AI Search',
