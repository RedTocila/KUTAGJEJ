-- Recreate increment_listing_engagement without referencing click_count.
-- CREATE OR REPLACE cannot change the returns-table shape, so drop first.
-- This does not drop any tables or data.
